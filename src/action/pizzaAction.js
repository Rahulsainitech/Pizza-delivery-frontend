...
export const getAllPizza = ()=>async(dispatch)=>{
    ...
    try {
        const res = await axios.get("https://rahul-5qlq.onrender.com/api/pizzas/getAllPizzas")
        // console.log(res)
...
export const addPizza = (pizza)=>async(dispatch)=>{
    ...
    try {
        const res = await axios.post("https://rahul-5qlq.onrender.com/api/pizzas/addPizza",{pizza})
        // console.log(res)
...
export const getPizzaById = (pizzaId)=>async(dispatch)=>{
    ...
    try {
        const res = await axios.post("https://rahul-5qlq.onrender.com/api/pizzas/getpizzabyid",{pizzaId})
        // console.log(res)
...
export const updatePizzaById = (updatedPizza)=>async(dispatch)=>{
    ...
    try {
        const res = await axios.post("https://rahul-5qlq.onrender.com/api/pizzas/updatepizza",{updatedPizza})
        // console.log(res)
...
export const deletePizzaById = (pizzaId)=>async(dispatch)=>{
    try {
     await axios.post("https://rahul-5qlq.onrender.com/api/pizzas/deletepizza",{pizzaId})
